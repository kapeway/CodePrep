...
namespace ArraysAndStringsTests
{
    ...
    public class UniqueStringWithAdditionalDataStructureTests
    {
        ...
        {
            var sut = new StringUniqueCharChecker();
            var result = sut.IsEveryCharacterUniqueWithAddDataStruct(stringToCheck);
